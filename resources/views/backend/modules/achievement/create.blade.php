@component('backend.includes.content' , ['title' => 'ایجاد دستاورد'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.achievement.index') }}">همه دستاورد ها</a></li>
        <li class="breadcrumb-item active">ایجاد دستاورد</li>
    @endslot
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد دستاورد جدید</h3>
                </div>
                <div class="card-body">
