@component('backend.includes.content' , ['title' => 'ایجاد رهنمود'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.guidelines.index') }}">همه رهنمود ها</a></li>
        <li class="breadcrumb-item active">ایجاد رهنمود</li>
    @endslot
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد رهنمود جدید</h3>
                </div>
                <div class="card-body">
