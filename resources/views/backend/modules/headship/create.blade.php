@component('backend.includes.content' , ['title' => 'ایجاد فورم عرضه خدمات'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.headships.index') }}">همه فورم های عرضه خدمات</a></li>
        <li class="breadcrumb-item active">ایجاد فورم عرضه خدمات</li>
    @endslot
    
    @section('page_title')
           ایجاد فورم عرضه خدمات
    @endsection
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد فورم عرضه خدمات جدید</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.headships.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
