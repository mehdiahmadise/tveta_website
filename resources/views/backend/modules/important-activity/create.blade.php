@component('backend.includes.content' , ['title' => 'ایجاد فعالیت مهم'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.important-activity.index') }}">همه فعالیت های مهم</a></li>
        <li class="breadcrumb-item active">ایجاد فعالیت مهم</li>
    @endslot
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد فعالیت مهم جدید</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.important-activity.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
