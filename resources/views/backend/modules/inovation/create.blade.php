@component('backend.includes.content' , ['title' => 'ایجاد ابتکار محصل'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.inovation.index') }}">همه ابتکار محصل ها</a></li>
        <li class="breadcrumb-item active">ایجاد ابتکار محصل</li>
    @endslot
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد ابتکار محصل جدید</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.inovation.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input name="student_father_name" type="text" class="form-control" id="student_father_name">
                        ...
                        <div class="form-group">
                            ...
                            <input name="student_grand_father_name" type="text" class="form-control" id="student_grand_father_name">
