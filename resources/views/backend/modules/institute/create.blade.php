@component('backend.includes.content' , ['title' => 'ایجاد انستیتوت'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.institute.index') }}">همه انستیتوت ها</a></li>
        <li class="breadcrumb-item active">ایجاد انستیتوت</li>
    @endslot
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد انستیتوت جدید</h3>
                </div>
                <div class="card-body">
