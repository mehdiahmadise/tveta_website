@component('backend.includes.content' , ['title' => 'رشته ها'])
    @slot('breadcrumb')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex">
                        ...
                        <div class="btn-group-sm mr-1">
                            {{-- @can('create-majors') --}}
                                <a href="{{ route('admin.major.create') }}" class="btn btn-info">ایجاد دسته بندی جدید</a>
                            {{-- @endcan --}}
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="tab-content tab-bordered" id="myTab3Content">
                        @foreach ($languages as $language)
                            @php
                                $majors = \App\Models\major::where('language', $language->lang)->orderByDesc('id')->get();
                            @endphp
                                                    ...
                                                    <td class="d-flex ">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                {{-- @can('edit-languages') --}}
                                                                    <a href="{{ route('admin.major.edit' , ['major' => $major->id]) }}"
                                                                    class="dropdown-item">ویرایش</a>
                                                                {{-- @endcan --}}
                                                                {{-- @can('delete-majors') --}}
                                                                    <a href="{{ route('admin.major.destroy', $major->id) }}" class="dropdown-item delete-item">حذف</a>
                                                                {{-- @endcan --}}
                                                            </div>
                                                        </div>
                                                    </td>
