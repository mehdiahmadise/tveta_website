@component('backend.includes.content' , ['title' => 'ایجاد طرزالعمل'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.procedures.index') }}">همه طرزالعمل ها</a></li>
        <li class="breadcrumb-item active">ایجاد طرزالعمل</li>
    @endslot
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد طرزالعمل جدید</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.procedures.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="">عنوان طرزالعمل</label>
