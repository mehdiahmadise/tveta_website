@component('backend.includes.content' , ['title' => 'ایجاد تدارکات و مالی'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.procurement-contracts.index') }}">همه تدارکات و مالی</a></li>
        <li class="breadcrumb-item active">ایجاد تدارکات و مالی</li>
    @endslot
    ...
    @section('page_title')
           ایجاد تدارکات و مالی
    @endsection
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد تدارکات و مالی جدید</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.procurement-contracts.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="">عنوان تدارکات و مالی</label>
