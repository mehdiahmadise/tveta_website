@component('backend.includes.content' , ['title' => 'ویرایش لیسه'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.school.index') }}">همه لیسه ها</a></li>
        <li class="breadcrumb-item active">ویرایش لیسه</li>
    @endslot
    @section('styles')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ویرایش لیسه جدید</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.school.update', $school->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="language" id="language-select" class="form-control select2">
                                ...
                                @foreach ($languages as $lang)
                                    <option {{ $lang->lang === $school->language ? 'selected' : '' }} value="{{ $lang->lang }}">{{ $lang->name }}</option>
                                @endforeach
                            </select>
                            @error('language')
                        ...
                        <div class="form-group">
                            ...
                            <select name="province" id="province" class="form-control select2">
                                ...
                                @foreach ($provinces as $province)
                                    <option {{ $province->id === $school->province_id ? 'selected' : '' }} value="{{ $province->id }}">{{ $province->name }}</option>
                                @endforeach
                            </select>
                            @error('province')
                                <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="form-group">
                            ...
                            <select name="district" id="district" class="form-control select2">
                                ...
                                @foreach ($districts as $district)
                                    <option {{ $district->id === $school->district_id ? 'selected' : '' }} value="{{ $district->id }}">{{ $district->name }}</option>
                                @endforeach
                            </select>
                            @error('district')
                                <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="form-group">
                            ...
                            <select name="center_type" id="center_type" class="form-control select2">
                                ...
                                @foreach ($center_types as $center_type)
                                    <option {{ $center_type->id === $school->center_type_id ? 'selected' : '' }} value="{{ $center_type->id }}">{{ $center_type->name }}</option>
                                @endforeach
                            </select>
                            @error('center_type')
                                <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="form-group">
                            <div class="row">   
                                ...
                                <div class="col-md-6 mt-4">
                                    <img src="{{ asset($school->image) }}" style="width: 100px; height:60px; border-radius: 5%;" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" id="name" value="{{ $school->name }}">
                            @error('name')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="address" type="text" class="form-control" id="address" value="{{ $school->address }}">
                            @error('address')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" class="form-control editor">{{ $school->content }}</textarea>
                            @error('content')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="meta_title" type="text" class="form-control" id="name" value="{{ $school->meta_title }}">
                            @error('meta_title')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" class="form-control">{{ $school->meta_description }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="inputDate10" class="form-control" name="date_shamsi" placeholder="" value="{{ old('date_shami', $school->date_shamsi) }}" aria-label="date8"
                                              aria-describedby="date8">
                                              @error('date_shamsi')
                                                <p class="text-danger">{{ $message }}</p>
                                              @enderror
                                            <input type="text" id="inputDate11" class="form-control" name="date_gregorian" value="{{ old('date_gregorian', $school->date_gregorian) }}" placeholder="" aria-label="date8"
                                              aria-describedby="date8">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control hijri-date-default" name="date_ghamari" value="{{ old('date_ghamari', $school->date_ghamari) }}" placeholder="تاریخ هجری قمری را وارد کنید">
                                        @error('date_ghamari')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <label class="custom-switch mt-2">
                                        <input id="s2" type="checkbox" class="switch" name="status" {{ $school->status == 1 ? 'checked' : '' }} value="1">
                                    </label>
                                </div>
                            </div>
