@component('backend.includes.content' , ['title' => 'ایجاد تعلیمات خاص'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.special-teaching.index') }}">همه تعلیمات خاص ها</a></li>
        <li class="breadcrumb-item active">ایجاد تعلیمات خاص</li>
    @endslot
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ایجاد تعلیمات خاص جدید</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.special-teaching.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
