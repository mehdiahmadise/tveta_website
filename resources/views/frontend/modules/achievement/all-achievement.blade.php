                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                          <div class="card">
                            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                              <img src="{{ URL::asset($achievement->image) }}" class="img-fluid" />
                              <a href="{{ url('/single-achievement'.'/'.$achievement->slug) }}">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                              </a>
                            </div>
                            <div class="card-body">
                              <h5 class="card-title font-weight-bold"><a>{{ $achievement->subject }}</a></h5>
                              <p class="card-text">
                                {!! Str::limit($achievement->content, 100, '...') !!}
                              </p>
                              <hr class="my-4"/>
                              <a href="{{ url('/single-achievement'.'/'.$achievement->slug) }}" class="btn btn-sm btn-info p-md-1 mb-0 text-white">اطلاعات بیشتر</a>
                            </div>
                          </div>
                        </div>
                        @endforeach
                ...
                <div class="col-lg-4">
                    <div class="widgets widgets-blog">
                        ...
                        <div class="single-widget widget-recentpost">
                            <h6 class="widget-title">دستاورد های اخیر</h6>
                            <ul>
                                @foreach ($latest_achievements as $latest_achievement)
                                    <li>
                                        ...
                                        <div class="widget-recentpost-content">
                                            <h6><a href="{{ url('single-achievement'.'/'.$latest_achievement->slug) }}">{{ $latest_achievement->subject }}</a></h6>
