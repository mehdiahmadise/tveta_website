...
@section('content')
    ...
    <div class="container">
        <div class="tm-breadcrumb">
            <h2 class="text-white">همه تفاهم نامه ها</h2>
            <ul>
                <li class="text-white"><a href="{{ route('home_page') }}" class="text-white">خانه</a></li>
                <li class="text-white" class="text-white">تفاهم نامه ها</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-lg-8 mt-4">
                    <div class="row mt-50-reverse">
                        ...
                        <div class="col-md-4">
                          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                            <img class="card-img-right flex-auto d-none d-lg-block" alt="Thumbnail [200x250]" src="{{ URL::asset($guideline->image) }}" style="object-fit: cover">
                            <div class="card-body d-flex flex-column align-items-start">
                                ...
                                <hr class="my-4"/>
                                <a class="btn btn-outline-info btn-sm" href="{{ url('/single-guideline'.'/'.$guideline->slug) }}">ادامه مطلب</a>
                            </div>
                          </div>
                        </div>
                      @endforeach
                    ...
                    <div class="tm-pagination mt-50">
                        {{ $guidelines->links('vendor.pagination.custom') }}
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="widgets widgets-blog">
                        ...
                        <div class="single-widget widget-recentpost">
                            ...
                            <ul>
                                @foreach ($latest_guidelines as $latest_guideline)
                                    <li>
                                        <a href="blog-details.html" class="widget-recentpost-image">
                                            <img src="{{ URL::asset($latest_guideline->image) }}"
                                                alt="blog thumbnail">
                                        </a>
                                        <div class="widget-recentpost-content">
                                            <h6><a href="{{ url('single-guideline'.'/'.$latest_guideline->slug) }}">{{ $latest_guideline->subject }}</a></h6>
                                            <span>{{ jdate($latest_guideline->created_at)->ago() }}</span>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
