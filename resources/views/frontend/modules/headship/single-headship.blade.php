...
@section('content')
   ...
   <div class="container">
       <div class="tm-breadcrumb">
           <h2 class="text-white">جزییات فورم عرضه خدمات</h2>
           <ul class="text-white">
               <li class="text-white"><a href="{{ route('home_page') }}" class="text-white">خانه</a></li>
               <li class="text-white"><a href="{{ route('frontend.all-achievements') }}" class="text-white">همه فورم های عرضه خدمات</a></li>
               <li class="text-white" class="text-white">{{ $headship->title }}</li>
           </ul>
       </div>
   </div>
</div>
               ...
               <div class="col-lg-8">
                   <div class="tm-blog blogitem">
                       ...
                       <div class="tm-blog-content">
                           <h6 class="tm-blog-title">{{ $headship->title }}</h6>
                           <ul class="tm-blog-meta">
                               {{-- <li><a href="#"><i class="ion-android-person"></i>{{ $news->user->name }}</a> </li> --}}
                               <li><i class="ion-android-calendar"></i>{{ jdate($headship->created_at)->ago() }}</li>
                               <li><a href="#"><i class="ion-chatbubbles"></i>3 نظر</a></li>
                           </ul>
                           <p>{!! $headship->content !!}</p>
                       </div>
               ...
               <div class="col-lg-4">
                   <div class="widgets widgets-blog">
                       ...
                       <div class="single-widget widget-recentpost">
                           <h6 class="widget-title">فورم های عرضه خدمات</h6>
                           <ul>
                                @foreach ($latest_headships as $latest_headship)
                                    <li>
                                        <div class="widget-recentpost-content">
                                            <h6><a href="{{ url('single-headship'.'/'.$latest_headship->slug) }}">{{ $latest_headship->title }}</a></h6>
