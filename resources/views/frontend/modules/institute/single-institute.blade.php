...
@section('content')
   ...
   <div class="container">
       <div class="tm-breadcrumb">
           <h2 class="text-white">جزییات انستیتوت</h2>
           <ul class="text-white">
               <li class="text-white"><a href="{{ route('home_page') }}" class="text-white">خانه</a></li>
               <li class="text-white"><a href="{{ route('frontend.all-institutes') }}" class="text-white">همه انستیتوت ها</a></li>
               <li class="text-white" class="text-white">{{ $institute->name }}</li>
           </ul>
       </div>
   </div>
</div>
                   ...
                   <div class="tm-blog blogitem">
                       <div class="tm-blog-topside">
                           <div class="tm-blog-thumb">
                               <img src="{{ URL::asset($institute->image) }}" alt="blog image">
                           </div>
                       </div>
                       <div class="tm-blog-content">
                           <h6 class="tm-blog-title">{{ $institute->name }}</h6>
                           <ul class="tm-blog-meta">
                               {{-- <li><a href="#"><i class="ion-android-person"></i>{{ $news->user->name }}</a> </li> --}}
                               <li><i class="ion-android-calendar"></i>{{ jdate($institute->created_at)->ago() }}</li>
                               <li><a href="#"><i class="ion-chatbubbles"></i>3 نظر</a></li>
                           </ul>
                           <p>{!! $institute->content !!}</p>
                       </div>
               ...
               <div class="col-lg-4">
                   <div class="widgets widgets-blog">
                       ...
                       <div class="single-widget widget-recentpost">
                           <h6 class="widget-title">جدیدترین انستیتوت ها ها</h6>
                           <ul>
                                @foreach ($latest_institutes as $latest_institute)
                                    <li>
                                        <a href="{{ url('single-institute'.'/'.$latest_institute->slug) }}" class="widget-recentpost-image">
