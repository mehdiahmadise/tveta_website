...
@section('content')
    ...
    <div class="container">
        <div class="tm-breadcrumb">
            <h2 class="text-white">همه تدارکات و مالی</h2>
            <ul>
                <li class="text-white"><a href="{{ route('home_page') }}" class="text-white">خانه</a></li>
                <li class="text-white" class="text-white">تدارکات و مالی</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-lg-8 mt-4">
                        ...
                        @foreach ($procurement_contracts as $procurement_contract)
                          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="card">
                              ...
                              <div class="card-body">
                                <h5 class="card-title font-weight-bold"><a>{{ $procurement_contract->subject }}</a></h5>
                                <p class="card-text">
                    ...
                    <div class="tm-pagination mt-50">
                      {{ $procurement_contracts->links('vendor.pagination.custom') }}
                    </div>
                </div>
                <div class="col-lg-4">
                                ...
                                @foreach ($latest_procurement_contracts as $latest_procurement_contract)
                                    <li>
                                        ...
                                        <div class="widget-recentpost-content">
                                            <h6><a href="{{ url('single-procurement-contract'.'/'.$latest_procurement_contract->slug) }}">{{ $latest_procurement_contract->subject }}</a></h6>
